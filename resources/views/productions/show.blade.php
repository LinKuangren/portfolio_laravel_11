...
@section('content')
    ...
    <div class="grid">
        <div class="grid justify-center">
            <img class="w-auto sm:max-w-lg" src="{{ $production->imageUrl() }}" alt="{{ $production->image }}">
        ...
        <div class="grid content-around sm:ml-4">
                ...
                <div class="mt-3 mb-3">
                    ...
                    <div class="gap-1 flex flex-wrap justify-center">
                        @foreach ($production->categories as $categorie)
                                <a class="py-2 px-6 text-white rounded-lg bg-gray-600 hover:bg-gray-500" href="{{ route('categories.showProductions', ['categorie' => $categorie->id, 'name' => $categorie->name]) }}">
